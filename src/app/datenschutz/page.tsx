    ...
    <div className="py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Datenerfassung auf dieser Website</h3>
          <p className="mb-4">
          ...
          <p className="mb-4">
            Wir hosten die Inhalte unserer Website bei einem externen Dienstleister. Personenbezogene Daten, die auf
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Verantwortliche Stelle</h3>
          <p className="mb-4">
            Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:
          </p>
          <p className="mb-4">
            S. Koukpari Handelsgesellschaft mbH<br />
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Beschwerderecht bei der zuständigen Aufsichtsbehörde</h3>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Recht auf Datenübertragbarkeit</h3>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">SSL- bzw. TLS-Verschlüsselung</h3>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Auskunft, Löschung und Berichtigung</h3>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            Cookies). Wir verwenden nur notwendige Cookies zur Speicherung Ihrer Cookie-Einwilligung.
          </p>
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Anfrage per E-Mail, Telefon oder Telefax</h3>
          <p className="mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">5. Plugins und Tools</h2>

          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Google Maps</h3>
          <p className="mb-4">
